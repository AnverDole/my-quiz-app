    ...
    <div v-if="show" class="delete-exam-modal">
      <div v-if="!showrequestmessagehandler" class="modal-base">
        <div class="modal-header">
          <span class="modal-title">Submit changes!</span>
        ...
        <div class="modal-body">
          <p class="main-massage">
            Are you shure you wants to submit the changes?
          </p>
        </div>
...
export default {
  ...
  methods: {
    ...
    Submit: function () {
      ...
      let data = self.prepireexamdata(self.exam);
      let result = myquizlib.Instructor.editExam(data);
